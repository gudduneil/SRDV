...
public class WhatSetGet {


    String whatId, en_name, fr_name, image_status, image, deselected_image;
    boolean touch;

    public WhatSetGet(String whatId, String en_name, String fr_name, String image_status, String image, String deselected_image, boolean touch) {
        this.whatId = whatId;

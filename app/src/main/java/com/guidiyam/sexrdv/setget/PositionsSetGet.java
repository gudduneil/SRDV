...
public class PositionsSetGet {


    String postionId, en_name, fr_name, image_status, image, deselected_image;
    boolean touch;


    public PositionsSetGet(String postionId, String en_name, String fr_name, String image_status, String image, String deselected_image, boolean touch) {

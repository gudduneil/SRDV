...
public class GoodsAdapter extends RecyclerView.Adapter<GoodsAdapter.ViewHolder>
{
    ...
    ActivityNewMeeting goodsdialogactivity;
    Context context;
    ArrayList<GoodsSetGet> arrayList;

    public GoodsAdapter(Context context,ArrayList<GoodsSetGet>arrayList,ActivityNewMeeting goodsdialogactivity) {
        this.context = context;
        this.arrayList=arrayList;
        this.goodsdialogactivity=goodsdialogactivity;
    }
...
//                    AppData.selectedcontact2.get(position).setSelect(false);
                        AppData.goodslistings.get(position).setTouch(false);

                        ActivityNewMeeting.goods_count--;
...
//                   AppData.selectedcontact2.get(position).setSelect(true);
                        AppData.goodslistings.get(position).setTouch(true);
                        ActivityNewMeeting.goods_count++;

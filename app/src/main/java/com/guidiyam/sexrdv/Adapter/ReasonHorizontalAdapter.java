...
public class    ReasonHorizontalAdapter extends RecyclerView.Adapter<ReasonHorizontalAdapter.ViewHolder>
{
    ...
    Activity activity;
    ArrayList<ReasonListingsSetGet> jsonarraylist;

    public ReasonHorizontalAdapter(Activity activity, ArrayList<ReasonListingsSetGet> json,ActivityNewMeeting activityNewMeeting) {
...
//                    v.getContext().startActivity(intent);
                    ...
                    activityNewMeeting.addDialogforreason();

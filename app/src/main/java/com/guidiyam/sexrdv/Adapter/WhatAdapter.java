...
public class WhatAdapter extends RecyclerView.Adapter<WhatAdapter.ViewHolder> {



    private AlertDialog alert11;
    ActivityNewMeeting whatdialogactivity;
    Context context;
    ArrayList<WhatSetGet> arrayList;

    public WhatAdapter(Context context,ArrayList<WhatSetGet>arrayList,ActivityNewMeeting whatdialogactivity) {
        this.context = context;
        this.arrayList=arrayList;
        this.whatdialogactivity=whatdialogactivity;
    }
...
//                    AppData.selectedcontact2.get(position).setSelect(false);
                        AppData.whatlistings.get(position).setTouch(false);

                        ActivityNewMeeting.what_count--;
...
//                   AppData.selectedcontact2.get(position).setSelect(true);
                        AppData.whatlistings.get(position).setTouch(true);
                        ActivityNewMeeting.what_count++;

...
public class WhereHorizontalAdapter extends RecyclerView.Adapter<WhereHorizontalAdapter.ViewHolder>
{
    ...
    Activity activity;
    ArrayList<WhereListingsSetGet> jsonarraylist;

    public WhereHorizontalAdapter(Activity activity, ArrayList<WhereListingsSetGet> json,ActivityNewMeeting activityNewMeeting) {
...
//                    v.getContext().startActivity(intent);
                   // AppData.partnerclick=true;
                    ...
                    activityNewMeeting.addDialogforwhere();

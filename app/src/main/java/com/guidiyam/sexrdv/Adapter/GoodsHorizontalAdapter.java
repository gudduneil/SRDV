...
public class GoodsHorizontalAdapter  extends RecyclerView.Adapter<GoodsHorizontalAdapter.ViewHolder>
{
    ...
    Activity activity;
    ArrayList<GoodsListingsSetGet> jsonarraylist;

    public GoodsHorizontalAdapter(Activity activity, ArrayList<GoodsListingsSetGet> json, ActivityNewMeeting activityNewMeeting) {
...
//                    v.getContext().startActivity(intent);
                    ...
                    activityNewMeeting.addDialogforgoods();

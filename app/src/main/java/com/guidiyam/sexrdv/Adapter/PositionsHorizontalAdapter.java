...
public class PositionsHorizontalAdapter  extends RecyclerView.Adapter<PositionsHorizontalAdapter.ViewHolder>
{
    ...
    Activity activity;
    ArrayList<PositionsListingsSetGet> jsonarraylist;

    public PositionsHorizontalAdapter(Activity activity, ArrayList<PositionsListingsSetGet> json,ActivityNewMeeting activityNewMeeting) {
...
//                    v.getContext().startActivity(intent);
                    ...
                    activityNewMeeting.addDialogforpositions();

...
public class FutureMeetingAdapter extends RecyclerView.Adapter<FutureMeetingAdapter.ViewHolder>{
    Activity activity;
    CAdapter2 cAdapter2;
Context context;
    ...
    public FutureMeetingAdapter(Activity activity) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.future_my_meeting, parent,false);

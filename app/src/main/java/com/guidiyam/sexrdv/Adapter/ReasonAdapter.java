...
public class ReasonAdapter extends RecyclerView.Adapter<ReasonAdapter.ViewHolder>
{
    ...
    ActivityNewMeeting reasondialogactivity;
    Context context;
    ArrayList<ReasonSetGet> arrayList;

    public ReasonAdapter(Context context,ArrayList<ReasonSetGet>arrayList,ActivityNewMeeting reasondialogactivity) {
        this.context = context;
        this.arrayList=arrayList;
        this.reasondialogactivity=reasondialogactivity;
    }
...
//                    AppData.selectedcontact2.get(position).setSelect(false);
                        AppData.reasonlistings.get(position).setTouch(false);

                        ActivityNewMeeting.reason_count--;
...
//                   AppData.selectedcontact2.get(position).setSelect(true);
                        AppData.reasonlistings.get(position).setTouch(true);
                        ActivityNewMeeting.reason_count++;

...
public class PositionsAdapter extends RecyclerView.Adapter<PositionsAdapter.ViewHolder>
{
    ...
    ActivityNewMeeting positionsdialogactivity;
    Context context;
    ArrayList<PositionsSetGet> arrayList;

    public PositionsAdapter(Context context,ArrayList<PositionsSetGet>arrayList,ActivityNewMeeting positionsdialogactivity) {
        this.context = context;
        this.arrayList=arrayList;
        this.positionsdialogactivity=positionsdialogactivity;
    }
...
//                    AppData.selectedcontact2.get(position).setSelect(false);
                        AppData.positionslistings.get(position).setTouch(false);

                        ActivityNewMeeting.positions_count--;
...
//                   AppData.selectedcontact2.get(position).setSelect(true);
                        AppData.positionslistings.get(position).setTouch(true);
                        ActivityNewMeeting.positions_count++;

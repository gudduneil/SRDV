...
public class PartnerWantingAdapter  extends RecyclerView.Adapter<PartnerWantingAdapter.ViewHolder> {
    Activity activity;
    String fr_pg;
    ActivityNewMeeting referance;
    ResumeMeeting referance2;
    public PartnerWantingAdapter(Activity activity,String fr_pg)
    {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent,  int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.wanting_content, parent,false);
